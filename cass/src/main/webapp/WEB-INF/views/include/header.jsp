...
body { font-family: 'Malgun Gothic', sans-serif !important; }
 ...
 <!-- Bootstrap 3.3.7 -->
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/common/css/ionicons.min.css">
  <!-- fullCalendar -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/common/css/fullcalendar.min.css">
  <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/common/css/fullcalendar.print.min.css" media="print">
  <!-- Theme style -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/common/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/common/css/_all-skins.min.css">
...
<div class="main-container ace-save-state" id="main-container">
	<div id="sidebar" class="sidebar h-sidebar navbar-collapse collapse ace-save-state" style="margin-top:0px;" data-sidebar="true" data-sidebar-scroll="true" data-sidebar-hover="true">
		...
		<ul class="nav nav-list" id="topMenuUl" style="min-height: 39px; top: 0px;">
			...
			<li class="hover highlight">
				<a data-mcode="MENU04" href="#">
				<i class="menu-icon fa fa-calendar" style="float: left;"></i>
				...
				<ul class="submenu can-scroll">
					<li class="hover highlight">
						<a data-mcode="MENU0101" href="<%=request.getContextPath() %>/SManage/PSM" >
						개인일정</a>
						<b class="arrow"></b></li>
					<li class="hover highlight">
						<a data-mcode="MENU0112" href="<%=request.getContextPath() %>/SManage/DSM">
						부서일정</a>
						<b class="arrow"></b>
					</li>					
				</ul>
